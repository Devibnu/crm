...
$systemMenu = [
    ...
    ['title' => 'Dynamic Menus', 'icon' => 'menu', 'route' => 'admin.system.menus.index'],
];
...
Route::view('/marketing/{any?}', 'admin.vuexy')->where('any', '.*')->name('vuexy.marketing');
Route::view('/customer-profile/{any?}', 'admin.vuexy')->where('any', '.*')->name('vuexy.customer-profile');
...
Route::prefix('admin/system')->name('admin.system.')->middleware('role:super_admin|admin')->group(function () {
    Route::get('users', [UserRoleController::class, 'index'])->middleware('permission:users.view')->name('users.index');
    Route::get('users/create', [UserRoleController::class, 'create'])->middleware('permission:users.create')->name('users.create');
    Route::post('users', [UserRoleController::class, 'store'])->middleware('permission:users.create')->name('users.store');
    Route::get('users/{user}', [UserRoleController::class, 'show'])->middleware('permission:users.view')->name('users.show');
    Route::get('users/{user}/edit', [UserRoleController::class, 'edit'])->middleware('permission:users.update')->name('users.edit');
    Route::put('users/{user}', [UserRoleController::class, 'update'])->middleware('permission:users.update')->name('users.update');
    Route::put('users/{user}/role', [UserRoleController::class, 'updateRole'])->middleware('permission:users.update')->name('users.role.update');
    Route::delete('users/{user}', [UserRoleController::class, 'destroy'])->middleware('permission:users.delete')->name('users.destroy');
