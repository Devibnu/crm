...
@section('content')
    @php
        $labels = ['APPROVED' => 'Disetujui', 'PENDING' => 'Sedang Ditinjau', 'REJECTED' => 'Ditolak', 'DRAFT' => 'Draft'];
                ...
                @foreach ($templates as $template)
                    ...
                    <article class="wa-template-card status-{{ strtolower($status ?: 'draft') }}">
                        <div class="wa-card-head">
                            ...
                            <div class="wa-card-badges">
                                ...
                                @if ($template->is_default)
                                    <span class="wa-default-badge">Template Aktif</span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="wa-card-actions">
                            ...
                            <button class="wa-card-btn secondary js-send-test-template" data-url="{{ route('admin.marketing.whatsapp-templates.send-test', $template) }}" @disabled($status !== 'APPROVED')>Send Test</button>
