...
const canUpdateInvoice = computed(() => ability.can('update', 'BackofficeInvoice'))
const invoiceAccessMessage = computed(() => canUpdateInvoice.value
  ? 'Anda dapat meninjau detail invoice dan menjalankan aksi lanjutan yang diizinkan pada peran ini.'
  : 'Mode baca aktif. Detail invoice masih terlihat, tetapi kirim, edit, dan pencatatan pembayaran dinonaktifkan.')
