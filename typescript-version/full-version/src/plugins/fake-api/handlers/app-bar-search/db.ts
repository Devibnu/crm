...
const getAppBarSearchTitle = (key: string) => getI18n().global.t(key).toString()

export const getAppBarSearchDb = (): DB => ({
  searchItems: [
    {
      title: 'Dashboards',
      category: 'dashboards',
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          icon: 'tabler-list',
          title: getAppBarSearchTitle('backoffice.search.invoiceList'),
        },
        {
          url: { name: 'apps-invoice-preview-id', params: { id: '5036' } },
          icon: 'tabler-file-description',
          title: getAppBarSearchTitle('backoffice.search.invoicePreview'),
        },
        {
          url: { name: 'apps-invoice-edit-id', params: { id: '5036' } },
          icon: 'tabler-file-pencil',
          title: getAppBarSearchTitle('backoffice.search.invoiceEdit'),
        },
        {
          url: { name: 'apps-invoice-add' },
          icon: 'tabler-file-plus',
          title: getAppBarSearchTitle('backoffice.search.invoiceAdd'),
        },
        {
