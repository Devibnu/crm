...
export interface ComposeEmailPayload {
  to: ComposeEmailRecipient[]
  cc?: ComposeEmailRecipient[]
  bcc?: ComposeEmailRecipient[]
  subject?: string
  message?: string
...
export const useEmail = () => {
  ...
  const sendEmail = async (payload: ComposeEmailPayload) => {
    return await $api<{ data: Email }>('/apps/email/send', {
      method: 'POST',
      body: payload,
    })
  }
