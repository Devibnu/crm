...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'governance-security-audit-trail': RouteRecordInfo<'governance-security-audit-trail', '/governance-security/audit-trail', Record<never, never>, Record<never, never>>,
    'integrasi-transaksi-contract-management-system': RouteRecordInfo<'integrasi-transaksi-contract-management-system', '/integrasi-transaksi/contract-management-system', Record<never, never>, Record<never, never>>,
    'login': RouteRecordInfo<'login', '/login', Record<never, never>, Record<never, never>>,
    'marketing-automation-campaign-execution': RouteRecordInfo<'marketing-automation-campaign-execution', '/marketing-automation/campaign-execution', Record<never, never>, Record<never, never>>,
    'marketing-automation-campaign-management': RouteRecordInfo<'marketing-automation-campaign-management', '/marketing-automation/campaign-management', Record<never, never>, Record<never, never>>,
    'marketing-automation-campaign-monitoring': RouteRecordInfo<'marketing-automation-campaign-monitoring', '/marketing-automation/campaign-monitoring', Record<never, never>, Record<never, never>>,
    'marketing-automation-campaign-planning': RouteRecordInfo<'marketing-automation-campaign-planning', '/marketing-automation/campaign-planning', Record<never, never>, Record<never, never>>,
    'marketing-automation-consent-management': RouteRecordInfo<'marketing-automation-consent-management', '/marketing-automation/consent-management', Record<never, never>, Record<never, never>>,
    'marketing-automation-customer-data-platform': RouteRecordInfo<'marketing-automation-customer-data-platform', '/marketing-automation/customer-data-platform', Record<never, never>, Record<never, never>>,
    'marketing-automation-landing-page-form-builder': RouteRecordInfo<'marketing-automation-landing-page-form-builder', '/marketing-automation/landing-page-form-builder', Record<never, never>, Record<never, never>>,
    'marketing-automation-marketing-analytics': RouteRecordInfo<'marketing-automation-marketing-analytics', '/marketing-automation/marketing-analytics', Record<never, never>, Record<never, never>>,
    'marketing-automation-social-media-engagement': RouteRecordInfo<'marketing-automation-social-media-engagement', '/marketing-automation/social-media-engagement', Record<never, never>, Record<never, never>>,
    'not-authorized': RouteRecordInfo<'not-authorized', '/not-authorized', Record<never, never>, Record<never, never>>,
    'omnichannel-email-inbox': RouteRecordInfo<'omnichannel-email-inbox', '/omnichannel/email-inbox', Record<never, never>, Record<never, never>>,
    'omnichannel-live-chat': RouteRecordInfo<'omnichannel-live-chat', '/omnichannel/live-chat', Record<never, never>, Record<never, never>>,
    'omnichannel-whatsapp': RouteRecordInfo<'omnichannel-whatsapp', '/omnichannel/whatsapp', Record<never, never>, Record<never, never>>,
    'omnichannel-whatsapp-broadcast': RouteRecordInfo<'omnichannel-whatsapp-broadcast', '/omnichannel/whatsapp/broadcast', Record<never, never>, Record<never, never>>,
    'omnichannel-whatsapp-broadcast-id': RouteRecordInfo<'omnichannel-whatsapp-broadcast-id', '/omnichannel/whatsapp/broadcast/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'omnichannel-whatsapp-broadcast-create': RouteRecordInfo<'omnichannel-whatsapp-broadcast-create', '/omnichannel/whatsapp/broadcast/create', Record<never, never>, Record<never, never>>,
    'omnichannel-whatsapp-flow': RouteRecordInfo<'omnichannel-whatsapp-flow', '/omnichannel/whatsapp/flow', Record<never, never>, Record<never, never>>,
    'omnichannel-whatsapp-inbox': RouteRecordInfo<'omnichannel-whatsapp-inbox', '/omnichannel/whatsapp/inbox', Record<never, never>, Record<never, never>>,
    'omnichannel-whatsapp-templates': RouteRecordInfo<'omnichannel-whatsapp-templates', '/omnichannel/whatsapp/templates', Record<never, never>, Record<never, never>>,
    ...
    'pelanggan': RouteRecordInfo<'pelanggan', '/pelanggan', Record<never, never>, Record<never, never>>,
    'pelaporan-dashboard-executive-dashboard': RouteRecordInfo<'pelaporan-dashboard-executive-dashboard', '/pelaporan-dashboard/executive-dashboard', Record<never, never>, Record<never, never>>,
    'pelaporan-dashboard-reporting': RouteRecordInfo<'pelaporan-dashboard-reporting', '/pelaporan-dashboard/reporting', Record<never, never>, Record<never, never>>,
    'pengguna': RouteRecordInfo<'pengguna', '/pengguna', Record<never, never>, Record<never, never>>,
    'percakapan': RouteRecordInfo<'percakapan', '/percakapan', Record<never, never>, Record<never, never>>,
    'register': RouteRecordInfo<'register', '/register', Record<never, never>, Record<never, never>>,
    'sales-enablement-dashboard': RouteRecordInfo<'sales-enablement-dashboard', '/sales-enablement/dashboard', Record<never, never>, Record<never, never>>,
    'sales-enablement-lead-form': RouteRecordInfo<'sales-enablement-lead-form', '/sales-enablement/lead-form', Record<never, never>, Record<never, never>>,
    'sales-enablement-lead-management': RouteRecordInfo<'sales-enablement-lead-management', '/sales-enablement/lead-management', Record<never, never>, Record<never, never>>,
    'sales-enablement-opportunity-board': RouteRecordInfo<'sales-enablement-opportunity-board', '/sales-enablement/opportunity-board', Record<never, never>, Record<never, never>>,
    'sales-enablement-opportunity-management': RouteRecordInfo<'sales-enablement-opportunity-management', '/sales-enablement/opportunity-management', Record<never, never>, Record<never, never>>,
    'sales-enablement-pipeline-forecasting': RouteRecordInfo<'sales-enablement-pipeline-forecasting', '/sales-enablement/pipeline-forecasting', Record<never, never>, Record<never, never>>,
    'sales-enablement-quotation-deal': RouteRecordInfo<'sales-enablement-quotation-deal', '/sales-enablement/quotation-deal', Record<never, never>, Record<never, never>>,
    'sales-enablement-sales-activity-tracking': RouteRecordInfo<'sales-enablement-sales-activity-tracking', '/sales-enablement/sales-activity-tracking', Record<never, never>, Record<never, never>>,
    'service-management-sla-dashboard': RouteRecordInfo<'service-management-sla-dashboard', '/service-management/sla-dashboard', Record<never, never>, Record<never, never>>,
    'service-management-ticket-form': RouteRecordInfo<'service-management-ticket-form', '/service-management/ticket-form', Record<never, never>, Record<never, never>>,
    'service-management-ticket-list': RouteRecordInfo<'service-management-ticket-list', '/service-management/ticket-list', Record<never, never>, Record<never, never>>,
    'sla-management': RouteRecordInfo<'sla-management', '/sla-management', Record<never, never>, Record<never, never>>,
    ...
    'tiket': RouteRecordInfo<'tiket', '/tiket', Record<never, never>, Record<never, never>>,
