...
declare global {
  ...
  const buildAuthAbilityRules: typeof import('./src/utils/crmAccess')['buildAuthAbilityRules']
  const buildCrmAbilityRules: typeof import('./src/utils/crmAccess')['buildCrmAbilityRules']
  ...
  const crmSubjects: typeof import('./src/utils/crmAccess')['crmSubjects']
  ...
  const mergeAbilityRules: typeof import('./src/utils/crmAccess')['mergeAbilityRules']
...
declare module 'vue' {
  ...
  interface ComponentCustomProperties {
    ...
    readonly buildAuthAbilityRules: UnwrapRef<typeof import('./src/utils/crmAccess')['buildAuthAbilityRules']>
    readonly buildCrmAbilityRules: UnwrapRef<typeof import('./src/utils/crmAccess')['buildCrmAbilityRules']>
    ...
    readonly crmSubjects: UnwrapRef<typeof import('./src/utils/crmAccess')['crmSubjects']>
    ...
    readonly mergeAbilityRules: UnwrapRef<typeof import('./src/utils/crmAccess')['mergeAbilityRules']>
