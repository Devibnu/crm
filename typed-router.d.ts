...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'customer-profile-slug': RouteRecordInfo<'customer-profile-slug', '/customer-profile/:slug', { slug: ParamValue<true> }, { slug: ParamValue<false> }>,
    'dashboards-slug': RouteRecordInfo<'dashboards-slug', '/dashboards/:slug', { slug: ParamValue<true> }, { slug: ParamValue<false> }>,
    ...
    'marketing$slug': RouteRecordInfo<'marketing$slug', '/marketing/:slug(.*)', { slug: ParamValue<true> }, { slug: ParamValue<false> }>,
    ...
    'sales-deals': RouteRecordInfo<'sales-deals', '/sales/deals', Record<never, never>, Record<never, never>>,
    'sales-leads': RouteRecordInfo<'sales-leads', '/sales/leads', Record<never, never>, Record<never, never>>,
    'sales-opportunities': RouteRecordInfo<'sales-opportunities', '/sales/opportunities', Record<never, never>, Record<never, never>>,
    ...
    'service-cases': RouteRecordInfo<'service-cases', '/service/cases', Record<never, never>, Record<never, never>>,
    'service-csat': RouteRecordInfo<'service-csat', '/service/csat', Record<never, never>, Record<never, never>>,
    'service-knowledge': RouteRecordInfo<'service-knowledge', '/service/knowledge', Record<never, never>, Record<never, never>>,
    'service-omnichannel': RouteRecordInfo<'service-omnichannel', '/service/omnichannel', Record<never, never>, Record<never, never>>,
    'service-sla': RouteRecordInfo<'service-sla', '/service/sla', Record<never, never>, Record<never, never>>,
    'service-tickets': RouteRecordInfo<'service-tickets', '/service/tickets', Record<never, never>, Record<never, never>>,
